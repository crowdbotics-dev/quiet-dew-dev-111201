"""
Django settings for quiet_dew_dev_111201 project.
...
ROOT_URLCONF = 'quiet_dew_dev_111201.urls'
...
WSGI_APPLICATION = 'quiet_dew_dev_111201.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_dew_dev_111201 API",
    "DESCRIPTION": "API documentation for quiet_dew_dev_111201 App",
    "VERSION": "v1",
}
